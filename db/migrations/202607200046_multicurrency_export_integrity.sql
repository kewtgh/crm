...
revoke all on function public.performance_export_rows_v220(uuid,date,date) from public,crm_system,crm_app;
grant execute on function public.performance_export_rows_v220(uuid,date,date) to crm_system, crm_worker;
revoke all on function public.sales_performance_report_v220(text,text,text) from public,crm_system;
grant execute on function public.sales_performance_report_v220(text,text,text) to crm_app;
