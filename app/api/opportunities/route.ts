...
const fail=(error:unknown)=>NextResponse.json({code:error instanceof DatabaseRequestError?error.code:"OPPORTUNITY_OPERATION_FAILED"},{status:error instanceof DatabaseRequestError?error.status:500});
