...
export function ProductsPage() {
  ...
  return <div className="page-stack products-page">
    ...
    <InlineMessage type="warning">{t("products.sessionWarning")}</InlineMessage>
