...
export function FinancePage({ initial }: { initial: FinanceOverview }) {
  ...
  const reload = async (nextPage = quotePage, query = quoteQuery, nextSections = sectionPages) => {
    try {
