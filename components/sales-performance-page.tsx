  ...
  return <div className="page-stack sales-performance-page">
    ...
    <section className="sales-main-grid">
      <article className="surface sales-trend-card">
        <div className="surface-heading"><div><p className="eyebrow">{t("eyebrow.targetActual")}</p><h2>{t("sales.targetTrend")}</h2></div><div className="chart-legend"><span><i className="target" />{t("sales.target")}</span><span><i className="actual" />{t("sales.actual")}</span></div></div>
      ...
      <article className="surface forecast-card">
        <div className="surface-heading"><div><p className="eyebrow">{t("eyebrow.forecastHealth")}</p><h2>{t("sales.forecastHealth")}</h2></div><StatusBadge tone={forecastAttainment >= 95 ? "green" : "amber"}>{t(forecastAttainment >= 95 ? "sales.nearTarget" : "sales.hasGap")}</StatusBadge></div>
    ...
    <section className="surface team-performance-card">
      <div className="surface-heading"><div><p className="eyebrow">{t("eyebrow.teamContribution")}</p><h2>{t("sales.teamProgress")}</h2></div><StatusBadge tone="blue">{t("sales.memberCount", { count: visibleMembers.length })}</StatusBadge></div>
    ...
    <section className="surface relationship-goals-card">
      <div className="surface-heading"><div><p className="eyebrow">{t("eyebrow.relationshipGoals")}</p><h2>{t("sales.relationshipTitle")}</h2><p>{t("sales.relationshipDescription")}</p></div><button className="secondary-button" type="button" onClick={() => setRelationshipDrawerOpen(true)}><Goal size={16} />{t("sales.manageRelationship")}</button></div>
    ...
    <section className="sales-bottom-grid">
      <article className="surface funnel-card"><div className="surface-heading"><div><p className="eyebrow">{t("eyebrow.conversionFunnel")}</p><h2>{t("sales.funnel")}</h2></div><ChartNoAxesCombined size={20} /></div><div className="sales-funnel">{funnel.map((stage) => <div key={stage.label}><span style={{ width: `${stage.width}%` }}><b>{t(stage.label)}</b><small>{t("sales.funnelItems", { count: stage.count })} · {stage.value}</small></span><em>{stage.conversion}</em></div>)}</div></article>
      <article className="surface insight-card"><div className="surface-heading"><div><p className="eyebrow">{t("eyebrow.actionableInsights")}</p><h2>{t("sales.insights")}</h2></div><Sparkles size={20} /></div><Insight tone="green" title={t("sales.insight.renewal")} detail={t("sales.insight.renewalHelp")} /><Insight tone="amber" title={t("sales.insight.proposal")} detail={t("sales.insight.proposalHelp")} /><Insight tone="blue" title={t("sales.insight.referral")} detail={t("sales.insight.referralHelp")} /></article>
    </section>
    ...
    {relationshipDrawerOpen && <>
      ...
      <aside className="record-drawer" role="dialog" aria-modal="true" aria-label={t("sales.relationshipDialog")}>
        <div className="drawer-heading"><div><p className="eyebrow">{t("eyebrow.relationshipTargets")}</p><h2>{t("sales.relationshipDialog")}</h2><p>{t("sales.relationshipDialogHelp")}</p></div><button ref={relationshipCloseRef} className="icon-button" type="button" aria-label={t("common.close")} onClick={() => setRelationshipDrawerOpen(false)}><X size={20} /></button></div>
