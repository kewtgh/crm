...
[migration audit](docs/SUPABASE_EXIT_AUDIT_AND_TARGET_ARCHITECTURE_2026-07-29.md), the
[execution plan](docs/POSTGRESQL_SELF_HOSTED_MIGRATION_EXECUTION_PLAN_2026-07-29.md), and the
