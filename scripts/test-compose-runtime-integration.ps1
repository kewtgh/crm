param(
  ...
  [string]$ApplicationImage = "lumina-crm-validation:3.8.17",
  [string]$OperationsImage = "lumina-crm-ops-validation:3.8.17"
)
...
$candidateTag = "lumina-crm-runtime-candidate-$Suffix`:3.8.17"
$rollbackTag = "lumina-crm-runtime-rollback-$Suffix`:3.8.17"
