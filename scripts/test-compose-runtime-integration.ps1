param(
  ...
  [string]$ApplicationImage = "lumina-crm-validation:3.7.0",
  [string]$OperationsImage = "lumina-crm-ops-validation:3.7.0"
)
...
$candidateTag = "lumina-crm-runtime-candidate-$Suffix`:3.7.0"
$rollbackTag = "lumina-crm-runtime-rollback-$Suffix`:3.7.0"
