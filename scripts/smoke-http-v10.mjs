...
const rawBody = JSON.stringify({ smoke: true, release: "2.2.1" });
...
try {
  ...
  process.stdout.write(
    "v2.2.1 HTTP security smoke passed: trusted origin, canonical signature, replay window, header tamper rejection, and event deduplication.\n",
  );
} finally {
  await fetch(
