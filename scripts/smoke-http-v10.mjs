...
const rawBody = JSON.stringify({ smoke: true, release: "1.1.0" });
...
try {
  ...
  process.stdout.write(
    "v1.1.0 HTTP security smoke passed: trusted origin, canonical signature, replay window, header tamper rejection, and event deduplication.\n",
  );
} finally {
  await fetch(
