...
assert(live.body?.version === releaseVersion, `liveness version is not ${releaseVersion}`);
...
process.stdout.write(
  `v${releaseVersion} base HTTP smoke passed: liveness, JSON auth errors, request IDs, nonce CSP, and removed registration.\n`,
);
