...
assert(live.body?.version === "2.1.1", "liveness version is not 2.1.1");
...
process.stdout.write(
  "v2.1.1 base HTTP smoke passed: liveness, JSON auth errors, request IDs, nonce CSP, and removed registration.\n",
);
