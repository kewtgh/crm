...
assert(live.body?.version === "1.2.0", "liveness version is not 1.2.0");
...
process.stdout.write(
  "v1.2.0 base HTTP smoke passed: liveness, JSON auth errors, request IDs, nonce CSP, and removed registration.\n",
);
