...
assert(live.body?.version === "2.1.0", "liveness version is not 2.1.0");
...
process.stdout.write(
  "v2.1.0 base HTTP smoke passed: liveness, JSON auth errors, request IDs, nonce CSP, and removed registration.\n",
);
